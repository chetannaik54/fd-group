...
@section('content')
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-4">FinTech is a rapidly evolving segment of the financial services sector where tech-focused startups and other new market entrants are disrupting how the financial services industry traditionally operates. FinTech companies and market disruption are augmenting the competitive scenario each passing day.</p>
                <p class="mb-4">According To PwC, India has experienced the emergence of numerous FinTech start-ups, accelerators and incubators over the last few years. India has everything going for it to establish itself as a global FinTech hub</p>
            </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            ...
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-4">With a large market of underserved/unserved customers, increasing mobile penetration, favorable demographics, an active start-up ecosystem and a large technology talent pool, India has a potent opportunity that is waiting to be seized in the FinTech space.</p>
                <p>According to a report by Deloitte, Indian FinTech companies could address a few of the critical structural issues afflicting Indian financial services-increase outreach, improve customer experience, reduce operational friction, and foster adoption and usage of the digital channel. Legacy prone processes and higher operating cost models of incumbent banks and financial service providers will give digital FinTech companies an edge, as banks play catch-up with these more nimble and innovative start-ups. The opportunity for FinTech lies in expanding the market, shaping customer behavior, and effecting long term changes in the financial industry.</p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white">
        ...
        <h2 class="text-3xl font-bold sm:text-4xl pt-10">Core Healthcare Sectors We Cover</h2>
        ...
        <div class="gap-16 item-center grid grid-cols-4">
            ...
            <a href=""
                ...
                <div>
                    ...
                    <div class="mt-4 border-t-2 border-indigo-100 pt-2">
                        <p class="text-sm font-medium uppercase tracking-widest text-gray-500">
                            Integrated And Digital Banking
                        </p>
                    </div>
                </div>
