...
@section('content')
    ...
    <section class="bg-white">
        ...
        <h2 class="text-3xl font-bold sm:text-4xl pt-10">Core Retail And Ecommerce Sectors We Cover</h2>
