    ...
    <section class="relative flex flex-wrap lg:h-screen lg:items-center">
        <div class="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
            <div class="mx-auto max-w-lg text-center">
                <h1 class="text-2xl font-bold sm:text-3xl">Employee Referral Program!</h1>

                <p class="mt-4 text-gray-500">
                    At Fidelis Group we encourage candidate referrals from employees to build a rock solid talent pool that
                    is conversant with the way we work and build on human capital. As an employee what you get is a cash
                    reward for sound referrals that augments our workforce.
                </p>
            </div>
                    ...
                    <div x-show.transition="step != 'complete'">
                        ...
                        <div class="border-b-2 py-4">
                            ...
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                <div class="flex-1">
                                    <div x-show="step === 1">
                                        <div class="text-lg font-bold text-gray-700 leading-tight">Your Details</div>
                                    </div>

                                    <div x-show="step === 2">
                                        <div class="text-lg font-bold text-gray-700 leading-tight">Reference Details</div>
                                    </div>
                        ...
                        <div class="py-10">
                            <div x-show.transition.in="step === 1">
                                ...
                                <div class="mb-5">
                                    <label for="firstname" class="font-bold mb-1 text-gray-700 block">Your name</label>
                                    <input type="text" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your name...">
                                </div>

                                <div class="mb-5">
                                    <label for="email" class="font-bold mb-1 text-gray-700 block">your Email</label>
                                ...
                                <div class="mb-5">
                                    <label for="email" class="font-bold mb-1 text-gray-700 block">Fidelis Employee ID</label>
                                    <input type="text"class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your Fidelis Employee ID...">
                                </div>
                            ...
                            <div x-show.transition.in="step === 2">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="mb-5">
                                        <label for="firstname" class="font-bold mb-1 text-gray-700 block">Reference name</label>
                                        <input type="text" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your name...">
                                    </div>
    
                                    <div class="mb-5">
                                        <label for="email" class="font-bold mb-1 text-gray-700 block">Reference Email address</label>
                                        <input type="email"class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your email address...">
                                    </div>

                                    <div class="mb-5">
                                        <label for="email" class="font-bold mb-1 text-gray-700 block">Reference C.V.</label>
                                        <input type="file"class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your email address...">
                                    </div>
    
                                    <div class="mb-5">
                                        <label for="profession" class="font-bold mb-1 text-gray-700 block">For which Profession</label>
                            ...
                            <div x-show.transition.in="step === 3">
                                <div class="mb-5">
                                    <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your message / any additional information</label>
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="w-1/2 text-right">
                                ...
                                <button @click="step = 'complete'" x-show="step === 3"
                                    class="w-52 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-blue-500 hover:bg-blue-600 font-medium">Refer my canidadte</button>
                            </div>
                        </div>
                    </div>
                </div>
