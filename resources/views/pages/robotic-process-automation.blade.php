...
@section('content')
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-4">With businesses today adopting more automation to accelerate their productivity, operational efficiency and reduce costs, the key now is to automate all low-level manual data handling and tasks that employers still rely on their workforce to fulfill, thus fostering a rapid shift to robotic process automation.</p>
            ...
            <div class="grid grid-rows-2 gap-4 mt-8 font-light text-gray-500 sm:text-lg dark:text-gray-400">
                <p>At Fidelis Group, our Robotic Process Automation Services are structured to help organizations integrate RPA with technologies like AI, machine learning, and knowledge driven systems to empower enterprise-wide transformation.</p>
                <p>According To Gartner, a staggering 45% enterprises will implement RPA By 2021 to streamline operations.</p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl">
            <h3 class="text-2xl text-black-100">Why RPA For Your Organization ?</h3>
        </div>
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-0 lg:px-6">
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                <ul class="list-disc hover:list-decimal">
                    <li>Reduce Staffing Costs And Human Error</li>
            ...
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                <ul class="list-disc hover:list-decimal">
                        ...
                        <li>Improved Efficiency And Output</li>
                        <li>Automate Low Priority Or Value Tasks</li>
                        <li>Seamlessly Integrates With Cognitive Technologies</li>
                </ul>
            </div>
        </div>
    </section>
                ...
                <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                    ...
                    <ul role="list" class="mb-8 space-y-4 text-left">
                        <li class="flex items-center space-x-3">
                            ...
                            <span>Develop Roadmaps, Platform & Strategy</span>
                        </li>
                        <li class="flex items-center space-x-3">
                            <!-- Icon -->
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span>Implementation Of RPA Processes</span>
                        </li>
                        <li class="flex items-center space-x-3">
                            <!-- Icon -->
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                    ...
                    <ul role="list" class="mb-8 space-y-4 text-left">
                        ...
                        <li class="flex items-center space-x-3">
                            ...
                            <span>Challenges And Recommendations</span>
                        </li>
                    </ul>
                    <a href="{{ route('contact-us') }}" class="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-indigo-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group">
                        <span class="absolute bottom-0 left-0 w-full h-1 transition-all duration-150 ease-in-out bg-indigo-600 group-hover:h-full"></span>
                ...
                <div
                    ...
                    <ul role="list" class="mb-8 space-y-4 text-left">
                        ...
                        <li class="flex items-center space-x-3">
                            ...
                            <span>Orchestration Of Bots</span>
                        </li>
                ...
                <div
                    ...
                    <ul role="list" class="mb-8 space-y-4 text-left">
                        ...
                        <li class="flex items-center space-x-3">
                            ...
                            <span>Identification Of Most Suitable Tools Based On Coverage</span>
                        </li>
                    </ul>
                    <a href="{{ route('contact-us') }}" class="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-indigo-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group">
                        <span class="absolute bottom-0 left-0 w-full h-1 transition-all duration-150 ease-in-out bg-indigo-600 group-hover:h-full"></span>
