    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-4">Medical services are one of the fields of business that fundamentally depends on IT. In the medical services industry, innovation is used for emergency clinic organization, the executives, testing, pharmacovigilance, administrative prerequisites, examination, clinical turn of events, and to help capability focuses utilized by facilities, specialists, and logical clinical scientists. IT foundations should be flawlessly connected to help the rising interest in innovation in the medical services industry.</p>
                <p class="mb-4">Through development and change for a future with refined innovation, Fidelis Technology Services upholds Medical services Accomplices in their endeavors to increment efficiency for a more significant level of care.</p>
            </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            ...
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-4">Medical care establishments have recognized that what's in the store has a place just with the people who work on a financially savvy esteem model, and we convey our medical services administrations to deliver proficient, dependable, and versatile frameworks, items, and benefit-driven models.</p>
            </div>
        </div>
    </section>
