...
<section class="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <div class="show z-[1030] w-full py-4 px-6 md:flex justify-between items-center text-center md:text-left">
        <div class="mb-4 md:mb-0 flex items-center flex-wrap justify-center md:justify-start prose md:prose-lg lg:prose-xl">
            ...
            &nbsp;&nbsp;
            <!-- Hover -->
            <a class="group relative inline-block focus:outline-none focus:ring" href="{{ route('careers') }}">
        ...
        <div class="flex items-center justify-center">
            <div style="background: url({{ asset('img/Dot-for-last-content.png') }}) top left no-repeat; flex-grow: 8">
                <img src="{{ asset('img/project-offer.svg') }}" alt="" style="width: 300px; padding: 60px 0 0 60px;">
            </div>
        </div>
    </div>
        ...
        <div class="lg:flex lg:items-start lg:gap-8">
            ...
            <div class="grid grid-cols-2 gap-8 mt-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                <div class="col-span-2">
                    <div>
                        ...
                        <p class="mt-4 text-white">
                            know the latest update about the Fidelis Group by recieving Blogs, News updates
                        </p>
                    </div>
                </div>
                ...
                <div class="col-span-2 sm:col-span-1">
                    <p class="font-medium text-white">Industries</p>
                ...
                <div class="col-span-2 sm:col-span-1">
                    <p class="font-medium text-white">Corporate</p>
                ...
                <div class="col-span-2 sm:col-span-1">
                    <p class="font-medium text-white">Career</p>
        ...
        <div class="pt-8 mt-8 border-t border-gray-100">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                <p class="text-xs text-left text-white">
                    &copy; 2022. Fidelis Group. All rights reserved.
                </p>
