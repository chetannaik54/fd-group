...
@section('content')
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Business Challenges</h3>
                ...
                <form action="#" method="POST">
                    <div class="overflow-hidden shadow sm:rounded-md">
                        <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                            <fieldset>
                                <p>The client is a famous healthcare practitioner who involved in treating various diseases
                                    through bio-magnetic therapy. The client wants to have a 3D mobile application for
                                    clients to locate scan points and their corresponding pairs and heal their health
                                    concerns individually.</p>
                            </fieldset>
                        </div>
                    </div>
                </form>
    ...
    <div class="mt-10 sm:mt-0">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Our Solution</h3>
    ...
    <div class="mt-10 sm:mt-0">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Challenge</h3>
            ...
            <div class="mt-5 md:col-span-2 md:mt-0">
                <form action="#" method="POST">
                    <div class="overflow-hidden shadow sm:rounded-md">
                        <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                            <fieldset>
                                <div class="text-base font-medium text-gray-900" aria-hidden="true">Challenge faced</div>
                ...
                <form action="#" method="POST">
                    <div class="overflow-hidden shadow sm:rounded-md">
                        <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                            <fieldset>
                                <legend class="sr-only">By Email</legend>
                                <div class="text-base font-medium text-gray-900" aria-hidden="true"></div>
                                <div class="mt-4 space-y-4">
                                    <p>Resources Deployment: 5 nos. ( Includes System Admins, N/W Engineers, DB Admins).</p>
                                </div>
                            </fieldset>
                        </div>
                    </div>
        ...
        <div class="show z-[1030] w-full py-4 px-6 md:flex justify-between items-center text-center md:text-left">
            <div class="flex items-center justify-center">
                <div style="flex-grow: 8">
                    <img src="http://localhost:8000/images/Case-Studies/lets-talk.svg" alt="" style="">
                </div>
            </div>
            ...
            <div
                ...
                <h2 class="mt-4">Have a similar project in mind</h2>
                <!-- Base -->
        ...
        <div class="px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
            <header class="text-center">
                <h2 class="text-xl font-bold text-gray-900 sm:text-3xl">
                    Other Case Studies you can checkout
                </h2>
            </header>
            ...
            <ul class="grid grid-cols-1 gap-4 mt-8 lg:grid-cols-3">
                ...
                <li class="lg:col-span-2 lg:col-start-2 lg:row-span-2 lg:row-start-1">
                    <a href="#" class="relative block group">
                        ...
                        <div class="absolute inset-0 flex flex-col items-start justify-end p-6">
                            <h3 class="text-xl font-medium text-white">Application Support Desk Operations</h3>
